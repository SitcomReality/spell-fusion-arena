...
export class FusionUI {
  ...
  render() {
      ...
      <div class="fusion-container">
        ...
        <div class="fusion-section">
          <div style="display:flex; align-items:center; justify-content:space-between;">
            ...
            <button class="fusion-preview-clear" title="Clear selected elements" style="margin-left:12px;">Clear</button>
          </div>
    ...
    // Wire header clear button to clear fusion selection
    const headerClearBtn = this.container.querySelector('.fusion-preview-clear');
    if (headerClearBtn) {
    ...
    // Set up preview clear callback (kept for compatibility)
